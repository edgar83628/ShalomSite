...
class UserPoint(models.Model):
	user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="points_user")
	name = models.CharField(max_length=25, null=True)
	belong_to = models.CharField(max_length=100, null=True)
	user_points = models.IntegerField()

	def __str__(self):
		return f"{self.name} | {self.user_points}"
